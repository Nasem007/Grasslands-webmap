...
map.getView().fit([-12907921.376677, 5555597.459255, -10784341.274808, 7542572.993168], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_GrasslandGeospatialDataBase_1,
    colName: 'ECODISTRIC (code)',
    zoom: 10,
    collapsed: true,
    map: map
});
